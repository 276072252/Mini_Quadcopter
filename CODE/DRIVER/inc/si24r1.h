...
//设置引脚电平
#define SI24R1_CSN_LOW   GPIOB->BRR  |= GPIO_Pin_1
#define SI24R1_CSN_HIGH  GPIOB->BSRR |= GPIO_Pin_1
#define SI24R1_CE_LOW    GPIOA->BRR  |= GPIO_Pin_4
#define SI24R1_CE_HIGH   GPIOA->BSRR |= GPIO_Pin_4
